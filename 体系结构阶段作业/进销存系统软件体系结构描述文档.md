...
(GiftBill,ImportBill,ImportReturnBill,LossBill,OverBill,PayBill,ReceiveBill,SaleBill,SaleReturnBill,WarningBill一样)
...
| CashBillDataService.findCashBills()      | d得到所有的持久化对象     |
...
(GiftBillDataService,ImportBillDataService,ImportReturnBillDataService,LossBillDataService,OverBillDataService,PayBillDataService,ReceiveBillDataService,SaleBillDataService,SaleReturnBillDataService,WarningBillDataService一样)
