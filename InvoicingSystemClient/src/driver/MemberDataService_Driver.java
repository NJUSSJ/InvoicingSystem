...
public class MemberDataService_Driver {
	public void drive(MemberDatabaseServiceMySqlImpl_Stub memberdataservice) throws RemoteException {
		memberdataservice.delete(new MemberPO(0, 0, 0, 0, null, null, null, null, 0, 0, 0, 0));
		memberdataservice.find("Jack");
		memberdataservice.finish();
		memberdataservice.init();
		memberdataservice.insert(new MemberPO(0, 0, 0, 0, null, null, null, null, 0, 0, 0, 0));
		memberdataservice.update(new MemberPO(0, 0, 0, 0, null, null, null, null, 0, 0, 0, 0));
	}
}
