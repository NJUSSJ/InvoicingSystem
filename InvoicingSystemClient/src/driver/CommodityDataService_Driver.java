...
public class CommodityDataService_Driver {
	public void drive(CommodityDatabaseServiceMySqlImpl_Stub stub){
		...
		stub.insert(new CommodityPO(null, 0, null, 0, 0, 0, 0, 0, 0));
		stub.delete(new CommodityPO(null, 0, null, 0, 0, 0, 0, 0, 0));
		stub.update(new CommodityPO(null, 0, null, 0, 0, 0, 0, 0, 0));
		stub.init();
		stub.finish();
