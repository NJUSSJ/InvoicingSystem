...
| ---- | ---------------------------- |
| 前置条件 | 管理员已登录                       |
| 后置条件 | 显示管理员主界面（AdministratorPanel） |
...
| 语法   | public SaleMessage applyPromotion(Sale s) |
| ---- | ---------------------------------------- |
...
| 语法   | public PromotionPO getPromotion() |
| ---- | --------------------------------- |
...
| 语法   | public SaleDetailsTablePO getSaleDetailsTable(String field) |
| ---- | ---------------------------------------- |
...
| 语法   | public MangeCourseTablePO getMangeCourseTable(String field) |
| ---- | ---------------------------------------- |
| 前置条件 | 筛选条件选择，财务人员/总经理已登录                       |
| 后置条件 | 返回符合筛选条件的信息                              |
...
| 语法   | public MangeSituationTablePO getMangeSituationTable(String field) |
| ---- | ---------------------------------------- |
| 前置条件 | 筛选条件选择，财务人员/总经理已登录                       |
| 后置条件 | 返回符合筛选条件的信息                              |
...
| 语法   | public BillPO getMangeSituationTable(BillPO po) |
| ---- | ---------------------------------------- |
...
| 语法   | public ImportbillPO makeImportbill（ImportbillPO po) |
| ---- | ---------------------------------------- |
| 前置条件 | 进货销售人员已登录                                |
| 后置条件 | 生成进货单                                    |
...
| 语法   | public ExportbillPO makeExportbill（ExportbillPO po) |
| ---- | ---------------------------------------- |
| 前置条件 | 进货销售人员已登录                                |
| 后置条件 | 生成进货退货单                                  |
...
| 语法   | public SalebillPO makeSalebill（SalebillPO po) |
| ---- | ---------------------------------------- |
| 前置条件 | 进货销售人员已登录                                |
| 后置条件 | 生成销售单                                    |

bill.makeSaleexportbill

| 语法   | public SaleexportbillPO makeSaleexportbill（SaleexportbillPO po) |
| ---- | ---------------------------------------- |
| 前置条件 | 进货销售人员已登录                                |
| 后置条件 | 生成销售退货单                                  |
...
| 语法   | public PaybillPO makePaybill（PaybillPO po) |
| ---- | ---------------------------------------- |
| 前置条件 | 财务人员已登录                                  |
| 后置条件 | 生成付款单                                    |
...
| 语法   | public GetbillPO makeGetbill（GetbillPO po) |
| ---- | ---------------------------------------- |
| 前置条件 | 财务人员已登录                                  |
| 后置条件 | 生成收款单                                    |
...
| 语法   | public GiftbillPO makeGiftbill（GiftbillPO po) |
| ---- | ---------------------------------------- |
...
| 语法   | public OverbillPO makeOverbill(OverbillPO po) |
| ---- | ---------------------------------------- |
...
| 语法   | public WarningbillPO makeWarningbill(WarningbillPO po) |
| ---- | ---------------------------------------- |
...
| 语法   | public CashbillPO makeCashbill(CashbillPO po) |
| ---- | ---------------------------------------- |
| 前置条件 | 财务人员已登录                                  |
| 后置条件 | 生成现金费用单                                  |
...
| 语法   | public DamagebillPO makeDamagebill(DamagebillPO po) |
| ---- | ---------------------------------------- |
